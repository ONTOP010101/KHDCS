          ...
          <div class="preview-main">
            <div class="panel-card">
              ...
              <div class="fake-table">
                <div class="fake-row"><div class="fake-thumb"></div><div class="fake-line"></div><div class="fake-line small"></div></div>
                <div class="fake-row"><div class="fake-thumb"></div><div class="fake-line"></div><div class="fake-line small"></div></div>
                <div class="fake-row"><div class="fake-thumb"></div><div class="fake-line"></div><div class="fake-line small"></div></div>
                <div class="fake-row"><div class="fake-thumb"></div><div class="fake-line"></div><div class="fake-line small"></div></div>
                <div class="fake-row"><div class="fake-thumb"></div><div class="fake-line"></div><div class="fake-line small"></div></div>
            ...
            <div class="panel-card">
              ...
              <div class="progress-list">
                <div class="progress-item">
                  <label><span>拍摄完成</span><span>82%</span></label>
                  <div class="progress-track"><div class="progress-fill" style="width:82%;"></div></div>
                </div>
                <div class="progress-item">
                  <label><span>图片整理</span><span>68%</span></label>
                  <div class="progress-track"><div class="progress-fill" style="width:68%;"></div></div>
                </div>
                <div class="progress-item">
                  <label><span>资料审核</span><span>74%</span></label>
                  <div class="progress-track"><div class="progress-fill" style="width:74%;"></div></div>
                </div>
                <div class="progress-item">
                  <label><span>最终交付</span><span>56%</span></label>
                  <div class="progress-track"><div class="progress-fill" style="width:56%;"></div></div>
                </div>
              </div>
            </div>
          </div>
